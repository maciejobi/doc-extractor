...
def extract_with_llm(text: str) -> dict[str, Any] | None:
    ...
    prompt = (
        ...
        "ZASADY DLA STRON (sprzedawca vs nabywca) - ważne:\n"
        "- seller_name to WYŁĄCZNIE nazwa sprzedawcy, buyer_name to WYŁĄCZNIE "
        "nazwa nabywcy. NIGDY nie łącz dwóch firm w jednym polu.\n"
        "- Jeśli obok siebie są dwie nazwy (np. osoba i spółka), ustal która "
        "należy do sprzedawcy (Sprzedawca/Wystawca/Seller), a która do nabywcy "
        "(Nabywca/Kupujący/Buyer), i rozdziel je do osobnych pól.\n"
        "- Każda nazwa firmy trafia tylko do JEDNEGO pola - nie powielaj.\n\n"
...
def extract_from_image(image_bytes: bytes, media_type: str) -> dict[str, Any] | None:
    ...
    prompt = (
        ...
        "- seller_name to WYŁĄCZNIE nazwa sprzedawcy, buyer_name to WYŁĄCZNIE "
        "nazwa nabywcy. NIGDY nie łącz dwóch firm w jednym polu - rozdziel je.\n"
